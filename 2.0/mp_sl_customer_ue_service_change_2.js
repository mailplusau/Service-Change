    ...
    function (ui, runtime, search, record, log, redirect, error, currentRecord, file, http, email, format) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET') {
                ...
                inlineHtml += '<div class="row">'
                inlineHtml += '<div class="col-xs-12 send_to_section"><div class="input-group"><span class="input-group-addon">NOTIFY <span class="mandatory" style="color:red">*</span></span><select multiple class="form-control send_to" id="send_to"><option></option>';
