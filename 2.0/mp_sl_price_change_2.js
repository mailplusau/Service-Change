    ...
    function (ui, email, runtime, search, record, http, log, redirect, task, format) {
        ...
        function onRequest(context) {
            if (context.request.method === 'GET') {
                ...
                inlineHtml += '<h1 style="font-size: 25px; font-weight: 700; color: #103D39; text-align: center">Scheduled Price Change</h1>';
                ...
                inlineHtml += '<hr style="height:5px; border-width:0; background-color: #379E8F; color: white;"></hr>';
                inlineHtml += '<br>';
        ...
        function dataTable_custlist() {
            var inlineQty = '<style>table#table_preview {font-size: 12px;text-align: center;border: none;}.dataTables_wrapper {font-size: 14px;}table#table_preview th{text-align: center;} .bolded{font-weight: bold;}</style>';
            inlineQty += '<table id="table_preview" class="table table-responsive table-striped customer tablesorter hide" style="width: 100%;">';
        ...
        function commRegSection(commReg) {
            ...
            */
            ...
            inlineQty += '<h4><span style="background-color: #379E8F" class="form-group label label-default col-xs-12">Commencement Register</span></h4>';
        ...
        function editTab(selector) {
            var inlineQty = '<style>table#data_preview_' + selector + ' {font-size: 12px;text-align: center;border: none;}.dataTables_wrapper {font-size: 14px;}table#data_preview_' + selector + ' th{text-align: center;} .bolded{font-weight: bold;}</style>';
             ...
             *  DataTable
            */
            inlineQty += '<table id="data_preview_' + selector + '" class="table table-responsive table-striped customer tablesorter" style="width: 100%;">';
            inlineQty += '<thead style="color: white; background-color: #379E8F;">';
            inlineQty += '<tr class="text-center">';
            inlineQty += '</tr>';
            inlineQty += '</thead>';
        ...
        function reviewTab(selector) {
            ...
            inlineQty += '<div class="row">';
            inlineQty += '<div class="col-xs-12 heading1">';
            inlineQty += '<h4><span style="background-color: #379E8F" class="form-group label label-default col-xs-12">REVIEW</span></h4>';
            inlineQty += '</div></div></div>';

            inlineQty += '<table id="data_preview_' + selector + '" class="table table-responsive table-striped customer tablesorter hide" style="width: 100%;">';
            inlineQty += '<thead style="color: white; background-color: #379E8F;">';
            inlineQty += '<tr class="text-center">';
            inlineQty += '</tr>';
            inlineQty += '</thead>';
        ...
        function uploadSCF() {
            ...
            inlineQty += '<h4 id="primary_table_title" class="primary_table_title_a hide" style="font-size: 25px; font-weight: 700; color: #103D39; text-align: center">Upload SCF</h4>';
