...
define([
    ...
    function onRequest(context) {
        if (context.request.method === "GET") {
            ...
            // Comm Reg
            // inlineHtml += '<div class="commRegSection hide">'; //hide
            // inlineHtml +=
            //     '<hr style="height:5px; border-width:0; background-color: #379E8F; color: white;"></hr>';
            // inlineHtml += "<br>";
            ...
            form.clientScriptFileId = 5500819; //
    ...
    function tabsSection() {
        ...
        inlineQty +=
            '<div class="tabSection" style="width: 95%; margin:auto; margin-bottom: 30px; margin-top: 30px;",><ul class="nav nav-pills nav-justified" style="margin:0%; ">';
        inlineQty +=
            '<li role="presentation" class="active"><a data-toggle="tab" href="#edit"><b>Edit</b></a></li>';
        inlineQty +=
            '<li role="presentation" class=""><a data-toggle="tab" href="#review"><b>Review</b></a></li>';
        inlineQty +=
            '<li role="presentation" class=""><a data-toggle="tab" href="#upload_scf"><b>Upload SCF</b></a></li>';
        inlineQty += "</ul></div>";
