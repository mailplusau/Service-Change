    ...
    function(ui, email, runtime, search, record, http, log, redirect, task, format) {
        ...
        function onRequest(context) {
            if (context.request.method === 'GET') {
                ...
                var commReg = 0;
                var cust_id = 0;
                var new_commReg = false;
                var header = 'Edit';

                if (!isNullorEmpty(params)) {
                    zee_id = parseInt(params.zeeid);
                    commReg = parseInt(params.commreg);
                    cust_id = parseInt(params.custid)
                    new_commReg = Boolean(params.new);
                }
                ...
                inlineHtml += '<h1 style="font-size: 25px; font-weight: 700; color: #103D39; text-align: center">Scheduled Price Change: ' + header + '</h1>';
        ...
        function editTab() {
            ...
            inlineQty += '<div class="col-xs-6"><div class="input-group"><span style="background-color: #379E8F; color: white;" class="input-group-addon">Date Effective <span class="mandatory">*</span></span><input type="date" id="date_effective" value="" class="form-control date_effective" disabled/></div></div>';
            // } else {
             ...
             *  Sales Type
             */
            inlineQty += '<div class="col-xs-6 commencementtype"><div class="input-group"><span style="background-color: #379E8F; color: white;" class="input-group-addon" id="commencementtype_text">Sale Type <span class="mandatory">*</span></span><select id="commencementtype" class="form-control commencementtype" disabled><option></option>';
