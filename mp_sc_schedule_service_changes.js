 ...
 * @Last modified time: 2022-07-01T15:11:26+10:00
 *
 */
 ...
 function scheduleServiceChange() {
   ...
   var searched_service_change = nlapiLoadSearch('customrecord_servicechg',
     'customsearch_scheduled_servicechg_record'); // TEST Search including TEST Customers - Anesu : customsearch_scheduled_servicechg_reco_2 | Original : customsearch_scheduled_servicechg_record
   ...
   resultSet_service_change.forEachResult(function(searchResult_service_change) {
     ...
     var servieChangeStatus = searchResult_service_change.getValue(
       'custrecord_servicechg_status');
     var serviceChangeDateEffective = searchResult_service_change.getValue(
       'custrecord_servicechg_date_effective');
     var serviceChangeNewPrice = searchResult_service_change.getValue(
       'custrecord_servicechg_new_price');
     var serviceChangeNewFreq = searchResult_service_change.getValue(
       'custrecord_servicechg_new_freq');
     var serviceChangeService = searchResult_service_change.getValue(
       'custrecord_servicechg_service');
     var serviceChangeServiceText = searchResult_service_change.getText(
       'custrecord_servicechg_service');
     var serviceChangeDefault = searchResult_service_change.getValue(
       'custrecord_default_servicechg_record');
     serviceChangeCommReg = searchResult_service_change.getValue(
       'custrecord_servicechg_comm_reg');
     var serviceChangeCanDate = searchResult_service_change.getValue(
       'custrecord_servicechg_cancellation_date');
     var serviceChangeCanReason = searchResult_service_change.getValue(
       'custrecord_servicechg_cancellation_reas');
     var serviceChangeCanNotice = searchResult_service_change.getValue(
       'custrecord_servicechg_cancellation_not');
     var serviceChangeCanComp = searchResult_service_change.getValue(
       'custrecord_servicechg_cancellation_comp');
     var customerID = searchResult_service_change.getValue(
       "custrecord_service_customer", "CUSTRECORD_SERVICECHG_SERVICE",
       null);
 
     var serviceZee = searchResult_service_change.getValue(
       "custrecord_service_franchisee", "CUSTRECORD_SERVICECHG_SERVICE",
       null);
     var servicePrice = searchResult_service_change.getValue(
       "custrecord_service_price", "CUSTRECORD_SERVICECHG_SERVICE", null);
 
     var serviceChangeType = searchResult_service_change.getValue(
     ...
     if (oldCommReg != serviceChangeCommReg) {
       ...
       if (!isNullorEmpty(oldCommReg)) {
         unique_scheduledCommReg = scheduledCommReg.filter(function(elem,
           index, self) {
         ...
         unique_activeCommReg = activeCommReg.filter(function(elem, index,
           self) {
           return index == self.indexOf(elem);
         });
 
         nlapiLogExecution('DEBUG', 'unique_activeCommReg',
           unique_activeCommReg);
         nlapiLogExecution('DEBUG', 'unique_scheduledCommReg',
           unique_scheduledCommReg);
 
 
         if (unique_scheduledCommReg.length == 1) {
 
           var searched_active_commreg = nlapiLoadSearch(
             'customrecord_commencement_register',
             'customsearch_smc_commreg_active');
 
           var newFilters = new Array();
           if (!isNullorEmpty(unique_activeCommReg)) {
             newFilters[newFilters.length] = new nlobjSearchFilter(
               'internalid', null, 'anyof', unique_activeCommReg);
           ...
           var activeCommRegResult = resultSet_active_commreg.getResults(0,
             2);
     ...
     if (serviceChangeDefault == '1') {
      nlapiLogExecution('DEBUG', 'serviceChangeDefault == 1');
       updateCurrentServiceChangeRecord(serviceChangeID, 2, null, null, null,
         null);
       updateCurrentServiceRecord(serviceChangeService)
       scheduledCommReg[scheduledCommReg.length] = serviceChangeCommReg;
 
       var commReg_search = nlapiLoadSearch(
         'customrecord_commencement_register',
         'customsearch_service_commreg_assign');
       var commReg_filter = new Array();
       commReg_filter[commReg_filter.length] = new nlobjSearchFilter(
         'custrecord_customer', null, 'anyof', customerID);
       commReg_filter[commReg_filter.length] = new nlobjSearchFilter(
         'custrecord_trial_status', null, 'is', 2);
       ...
       comm_reg_results.forEachResult(function(searchResult) {
         ...
         if (count_commReg > 1) {
          ...
          //  nlapiCreateError('More than 1 Active CommReg',
       ...
       var searched_service_change_2 = nlapiLoadSearch(
         'customrecord_servicechg',
         'customsearch_active_servicechg_records');
 
       var newFilters_2 = new Array();
       newFilters_2[newFilters_2.length] = new nlobjSearchFilter(
         'custrecord_servicechg_service', null, 'is', serviceChangeService
       );
       ...
       var serviceChangeResult_2 = resultSet_service_change_2.getResults(0,
         2);
 
       nlapiLogExecution('DEBUG', 'serviceChangeResult_2.length',
         serviceChangeResult_2.length)
 
       if (serviceChangeResult_2.length > 1) {
         for (var x = 0; x < (serviceChangeResult_2.length - 1); x++) {
           var serviceChangeID_2 = serviceChangeResult_2[x].getValue(
             'internalid');
           updateCurrentServiceChangeRecord(serviceChangeID_2, 3, null, null,
             null, null);
         }
         ...
         var serviceChangeID_2 = serviceChangeResult_2[0].getValue(
           'internalid');
           nlapiLogExecution('DEBUG', 'serviceChangeResult_2.length == 1', serviceChangeID_2)
         var servieChangeStatus_2 = serviceChangeResult_2[0].getValue(
           'custrecord_servicechg_status');
         var servieChangeCommReg_2 = serviceChangeResult_2[0].getValue(
           'custrecord_servicechg_comm_reg');
         var servieChangeServiceMon_2 = serviceChangeResult_2[0].getValue(
           "custrecord_service_day_mon", "CUSTRECORD_SERVICECHG_SERVICE",
           null);
         var servieChangeServiceTue_2 = serviceChangeResult_2[0].getValue(
           "custrecord_service_day_tue", "CUSTRECORD_SERVICECHG_SERVICE",
           null);
         var servieChangeServiceWed_2 = serviceChangeResult_2[0].getValue(
           "custrecord_service_day_wed", "CUSTRECORD_SERVICECHG_SERVICE",
           null);
         var servieChangeServiceThu_2 = serviceChangeResult_2[0].getValue(
           "custrecord_service_day_thu", "CUSTRECORD_SERVICECHG_SERVICE",
           null);
         var servieChangeServiceFri_2 = serviceChangeResult_2[0].getValue(
           "custrecord_service_day_fri", "CUSTRECORD_SERVICECHG_SERVICE",
           null);
         var servieChangeServiceAdhoc_2 = serviceChangeResult_2[0].getValue(
           "custrecord_service_day_adhoc", "CUSTRECORD_SERVICECHG_SERVICE",
           null);
         ...
         if (!isNullorEmpty(serviceChangeCanDate)) {
           ...
           updateCurrentServiceChangeRecord(serviceChangeID_2, 3,
             serviceChangeCanDate, serviceChangeCanReason,
             serviceChangeCanNotice, serviceChangeCanComp);
           updateScheduledServiceChangeRecord(serviceChangeID, 3, null, null);
 
         } else {
           var currentServicePrice = updateServiceRecord(
             serviceChangeService, serviceChangeNewPrice,
             serviceChangeNewFreq);
           updateCurrentServiceChangeRecord(serviceChangeID_2, 3, null, null,
             null, null);
           updateScheduledServiceChangeRecord(serviceChangeID, 2,
             currentServicePrice, freqArray);
         }
        ...
        nlapiLogExecution('DEBUG', 'serviceChangeResult_2.length == 0')
         var currentServicePrice = updateServiceRecord(serviceChangeService,
           serviceChangeNewPrice, serviceChangeNewFreq);
         updateScheduledServiceChangeRecord(serviceChangeID, 2,
           currentServicePrice, freqArray);
       }
     ...
     nlapiLogExecution('DEBUG', 'serviceChangeServiceText',
       serviceChangeServiceText);
     nlapiLogExecution('DEBUG', 'serviceChangeType', serviceChangeType);
     if (serviceChangeServiceText != 'MPEX Pickup' && (serviceChangeType ==
         'Extra Service' || serviceChangeType == 'Change of Frequency' ||
         serviceChangeType == 'Increase of Frequency' || serviceChangeType ==
         'Decrease of Frequency')) {
       nlapiLogExecution('DEBUG', 'editing Green Tick');
       if (serviceChangeType == 'Change of Frequency' || serviceChangeType ==
         'Increase of Frequency' || serviceChangeType ==
         'Decrease of Frequency') {
         var service_record = nlapiLoadRecord('customrecord_service',
           serviceChangeService);
       ...
       customer_record.setFieldValue(
         'custentity_date_of_last_price_increase', getDate());
       nlapiSubmitRecord(customer_record);
     }
   ...
   if (!isNullorEmpty(oldCommReg)) {
     ...
     unique_scheduledCommReg = scheduledCommReg.filter(function(elem, index,
       self) {
       return index == self.indexOf(elem);
     });
     ...
     nlapiLogExecution('DEBUG', 'unique_scheduledCommReg.length',
       unique_scheduledCommReg.length);
     ...
     if (unique_scheduledCommReg.length == 1) {
       ...
       if (!isNullorEmpty(unique_activeCommReg)) {
         ...
         var newFilters = new Array();
         newFilters[newFilters.length] = new nlobjSearchFilter('internalid',
           null, 'anyof', unique_activeCommReg);
 ...
 function inactiveServiceRecord(id) {
   try {
     ...
     nlapiSendEmail(409635, ['ankith.ravindran@mailplus.com.au'],
       'Scheduled Service Change: Cannot Update Service Record to Inactive',
       message, null);
   }
 }
 ...
 function updateServiceRecord(id, price, freq) {
   ...
   try {
     var activeServiceRecord = nlapiLoadRecord('customrecord_service', id);
     var currentServicePrice = activeServiceRecord.getFieldValue(
     ...
     activeServiceRecord.setFieldValue('custrecord_service_date_last_price_upd',
       getDate());
     nlapiSubmitRecord(activeServiceRecord);
     ...
     nlapiSendEmail(409635, ['ankith.ravindran@mailplus.com.au'],
       'Scheduled Service Change: Cannot Update Service Record', message, null
     );
 ...
 function updateCurrentServiceChangeRecord(id, status, can_date, can_reason,
   can_notice, can_comp) {
   try {
     var activeServiceChangeRecord = nlapiLoadRecord('customrecord_servicechg',
       id);
 
     activeServiceChangeRecord.setFieldValue('custrecord_servicechg_status',
       status);
 
     activeServiceChangeRecord.setFieldValue(
       'custrecord_servicechg_cancellation_date', can_date);
     activeServiceChangeRecord.setFieldValue(
       'custrecord_servicechg_cancellation_reas', can_reason);
     activeServiceChangeRecord.setFieldValue(
       'custrecord_servicechg_cancellation_not', can_notice);
     activeServiceChangeRecord.setFieldValue(
       'custrecord_servicechg_cancellation_comp', can_comp);
     ...
     nlapiSendEmail(409635, ['ankith.ravindran@mailplus.com.au'],
       'Scheduled Service Change: Cannot Update Service Change Record',
       message, null);
 
   }
 }
 
 function updateScheduledServiceChangeRecord(id, status, service_price,
   freq_array) {
   try {
     var activeServiceChangeRecord = nlapiLoadRecord('customrecord_servicechg',
       id);
     ...
     activeServiceChangeRecord.setFieldValue('custrecord_servicechg_old_price',
       service_price);
     activeServiceChangeRecord.setFieldValue('custrecord_servicechg_old_freq',
       freq_array);
    ...
    */
    ...
    financeAllocateSearch.addFilter(new nlobjSearchFilter('custrecord_price_chg_it_serv_chg_id', null, 'is', id));
    ...
    if (!isNullorEmpty(financeAllocateGetResults.length > 0)){
        ...
        financeAllocateRecord.setFieldValue('isinactive', 'T'); // Set Record to Inactive
     ...
     nlapiSendEmail(409635, ['ankith.ravindran@mailplus.com.au'],
       'Scheduled Service Change: Cannot Update Service Change Record',
       message, null);
       nlapiSendEmail(409635, ['anesu.chakaingesu@mailplus.com.au'],
       'Scheduled Service Change: Cannot Update Service Change Record',
       message, null);
 ...
 function updateCurrentServiceRecord(id) {
   try {
     ...
     nlapiSendEmail(409635, ['ankith.ravindran@mailplus.com.au'],
       'Scheduled Service Change: Cannot Update Service Record to Active',
       message, null);
 ...
 function updateCommReg(id, status) {
   ...
   try {
     ...
     nlapiSendEmail(409635, ['ankith.ravindran@mailplus.com.au'],
       'Scheduled Service Change: Cannot Update Comm Reg Status', message,
       null);
 ...
 function createCommReg(customer, dateEffective, zee, state, sendemail) {
   try {
     ...
     customer_comm_reg.setFieldValue('custrecord_comm_date_signup',
       dateEffective);
     ...
     if (sendemail == 'T') {
       ...
       customer_comm_reg.setFieldValue('custrecord_commreg_sales_record',
         parseInt(nlapiGetFieldValue('custpage_salesrecordid')));
     ...
     nlapiSendEmail(409635, ['ankith.ravindran@mailplus.com.au'],
       'Scheduled Service Change: Cannot Create Comm Reg', message, null);
 ...
 function loadCommReg(id, dateEffective) {
   try {
     customer_comm_reg = nlapiLoadRecord('customrecord_commencement_register',
       id);
     customer_comm_reg.setFieldValue('custrecord_date_entry', getDate());
     customer_comm_reg.setFieldValue('custrecord_comm_date', dateEffective);
     customer_comm_reg.setFieldValue('custrecord_comm_date_signup',
     ...
     nlapiSendEmail(409635, ['ankith.ravindran@mailplus.com.au'],
       'Scheduled Service Change: Cannot Update Comm Reg with DE/Date Sign Up',
       message, null);
