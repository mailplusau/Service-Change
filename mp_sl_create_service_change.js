 ...
 * @Last Modified time: 2018-08-20 09:42:31
 *
 */
...
function serviceChange(request, response) {
	if (request.getMethod() == "GET") {
		...
		inlineQty += '<div class="col-xs-6 service_type_section"><div class="input-group"><span class="input-group-addon">SERVICE</span><input type="hidden" id="servicechange_id" value="" /><input type="hidden" id="service_id" value="" /><select class="form-control service_type" id="service_type">';
